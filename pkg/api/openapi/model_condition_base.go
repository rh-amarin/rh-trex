...
// checks if the ConditionBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConditionBase{}

// ConditionBase Common data for status objects, part of: - Status entity (stored in DB) - Request payload
...
type _ConditionBase ConditionBase
...
func (o ConditionBase) MarshalJSON() ([]byte, error) {
...
func (o ConditionBase) ToMap() (map[string]interface{}, error) {
...
func (o *ConditionBase) UnmarshalJSON(data []byte) (err error) {
	...
	varConditionBase := _ConditionBase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConditionBase)

	if err != nil {
		return err
	}

	*o = ConditionBase(varConditionBase)

	return err
}

type NullableConditionBase struct {
	value *ConditionBase
	isSet bool
}

func (v NullableConditionBase) Get() *ConditionBase {
	return v.value
}

func (v *NullableConditionBase) Set(val *ConditionBase) {
	v.value = val
	v.isSet = true
}

func (v NullableConditionBase) IsSet() bool {
	return v.isSet
}

func (v *NullableConditionBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConditionBase(val *ConditionBase) *NullableConditionBase {
	return &NullableConditionBase{value: val, isSet: true}
}

func (v NullableConditionBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConditionBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
